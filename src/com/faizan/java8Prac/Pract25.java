...
public class Pract25 {
	...
	public static void convertIntoMap() {
		...
		list.stream().collect(Collectors.toMap(v -> v, v -> v.length())).entrySet().stream()
				.forEach(entry -> System.out.println(entry));
	}
	...
	public static void completableFutureSuplyAs() {
	 ...
	 public static void converIntStreamToStream() {
		 IntStream intStream =IntStream.of(1,4,8,9);
	 ...
	 public static void findSumReduce() {
		 ...
		 System.out.println(integer +" "+sum +" "+reduce +" "+collect);
