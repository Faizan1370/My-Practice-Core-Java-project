...
public class Pract14 {
	...
	public static void evenNumber() {
		List<Integer> list = Arrays.asList(2,5,7,8,2);
	...
	public static void mergerTwoStream() {
	 ...
	 public static void kthHiehestSal() {
		 int k=2;
		 Employee employee = list.stream().sorted(Comparator.comparingInt(Employee::getSalary).reversed()).skip(k-1).findFirst().get();
	 ...
	 public static void converIntStreamToStream() {
        IntStream intStream = IntStream.of(1,4,7,9);
	 ...
	 static{
		 ...
		 Employee emp1= new Employee(700, "Zaheer", "QA tester",500);
		...
		// System.out.println(optional);
		 list.forEach(emp->{
			...
			// System.out.println(Optional.ofNullable(emp.getName()).orElse("abc"));
			 System.out.println(Optional.ofNullable(emp.getName()).map(str->str.toUpperCase()).orElse("deault valeu"));
		 });
	 }
