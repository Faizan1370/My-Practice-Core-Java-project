...
public class SortMap {
	 ...
	 public static void sortMap1() {
		 ...
		 .sorted(Map.Entry.comparingByValue()).forEach(emp->System.out.println(emp));
	 }
	 
	 public static void sortMap2() {
		 getMapValues().entrySet().stream()
		 .sorted(Map.Entry.comparingByKey(Comparator.comparingInt(emp->emp.getSalary()))).forEach(emp->System.out.println(emp));
	 ...
	 public static void sortMap5() {
		 ...
		 Collections.sort(list, 
			...
			(Entry<Employee, Integer> o1, Entry<Employee, Integer> o2) ->{
