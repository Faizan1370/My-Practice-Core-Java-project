...
public class SortMap {
	 ...
	 public static void sortbyValue() {
	  ...
	  public static void sortbyKey() {
		 getMapValues().entrySet().stream().sorted(Map.Entry.comparingByKey(Comparator.comparing(emp->((Employee) emp).getSalary()).reversed())).forEach(emp->System.out.println(emp));
	 }
	 ...
	 public static void oldApproach() {
		 ...
		 Collections.sort(list,new Comparator<Entry<Employee,Integer>>() {
			...
			public int compare(Entry<Employee, Integer> o1, Entry<Employee, Integer> o2) {
				return Integer.compare(o1.getKey().getSalary(), o2.getKey().getSalary()); //o1.getValue()-o2.getValue();
			}
		});
