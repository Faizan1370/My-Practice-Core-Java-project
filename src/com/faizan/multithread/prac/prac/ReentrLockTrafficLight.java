...
public class ReentrLockTrafficLight {
	...
	public void printRed() {
		while(true) {
			...
			System.out.println("Current cdolor :"+currentColor);
			try {
				Thread.sleep(1000);
			} catch (InterruptedException e) {
				// TODO Auto-generated catch block
	...
	public static void main(String[] args) {
		ReentrLockTrafficLight light = new ReentrLockTrafficLight();
		Thread t1 = new Thread(()->light.printRed());
		Thread t2 = new Thread(()->light.printYwllow());
