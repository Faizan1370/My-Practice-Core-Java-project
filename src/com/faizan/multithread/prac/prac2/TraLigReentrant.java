...
public class TraLigReentrant {
	...
	public static void main(String[] args) {
		TraLigReentrant ligPro = new TraLigReentrant();
		Thread t1 = new Thread(()->ligPro.printRed());
		Thread t2 = new Thread(()->ligPro.printYellow());
		Thread t3 = new Thread(()->ligPro.printGreen());
