...
public class TrafficLight {
	...
	public synchronized void printRed() {
		while(true) {
			while(!currentColor.equalsIgnoreCase("red")) { // we can use while loop if or while but while is best practice because will retry to until condition met
				try {
					wait();
	...
	public synchronized void printYello() {
		while(true) {
