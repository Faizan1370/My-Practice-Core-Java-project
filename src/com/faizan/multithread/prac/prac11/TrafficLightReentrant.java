...
public class TrafficLightReentrant {
	...
	public static void main(String[] args) {
		TrafficLightReentrant lightReentrant = new TrafficLightReentrant();
		Thread t1= new Thread(()->lightReentrant.printRed());
		Thread t2 = new Thread(()->lightReentrant.printYellow());
		Thread t3= new Thread(()->lightReentrant.printGreen());
