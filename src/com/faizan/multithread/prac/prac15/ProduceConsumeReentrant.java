...
public class ProduceConsumeReentrant {
	...
	public static void main(String[] args) {
		ProduceConsumeReentrant consumeReentrant = new ProduceConsumeReentrant();
		Thread t1= new Thread(()->consumeReentrant.produce());
		Thread t2= new Thread(()->consumeReentrant.consume());
